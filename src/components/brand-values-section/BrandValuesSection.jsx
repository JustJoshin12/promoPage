...
export const BrandValuesSection = () => {
  return (
    <section id="community-values" className="bg-galactic-background pt-10">
      ...
      >
        <ExampleContent
          title="Connecting the Anime Community in Real Life"
          context="Anime fans deserve more than endless scrolling. Nymify helps people find nearby events, meet others who share their passion, and build lasting community beyond the screen."
        />
      </TextParallaxContent>
      <TextParallaxContent
      ...
      >
        <ExampleContent
          ...
          context="Every release is designed to deliver real value for attendees, creators, and organizers. If a feature is not reliable, intuitive, and ready for real-world use, it does not go live."
        />
      </TextParallaxContent>
      <TextParallaxContent
      ...
      >
        <ExampleContent title="Building What's Next for Fans and Creators" context="We continuously improve discovery, visibility, and engagement so the platform grows with the community. When new needs emerge, we move quickly to turn them into meaningful product improvements." />
      </TextParallaxContent>
    </section>
  );
};
