...
export const FeatureToggles = () => {
  ...
  return (
    <section id="features" className="relative mx-auto max-w-6xl px-2 md:px-4 md:py-10">
      <SectionHeading>Discover the Anime World Near You</SectionHeading>
      <SectionSubheading>
      Unleash Your Inner Otaku: Find and Join Local Anime Events Near You!
      </SectionSubheading>
