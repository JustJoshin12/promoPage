...
const ATTEND_EXCLUDED_TITLES = new Set(["Event Organizers", "Event Analytics"]);

export const ATTEND_BENEFIT_OPTIONS = OPTIONS.filter(
  (option) => !ATTEND_EXCLUDED_TITLES.has(option.title),
);

const CREATE_INCLUDED_TITLES = new Set([
  "Event Organizers",
  "Event Analytics",
  "Finding Local Fans",
...
export const CREATE_BENEFIT_OPTIONS = OPTIONS.filter((option) =>
  CREATE_INCLUDED_TITLES.has(option.title),
);
